...
public class PinkCircle extends View {
    private String TAG = PinkCircle.class.getSimpleName();
    ...
    private void initbyAttributes(TypedArray attributes) {
        finished_color = attributes.getColor(R.styleable.CircleProgress_finishedColor, Color.parseColor("#FF369B"));
    ...
    public PinkCircle(Context context) {
        this(context, null);
    }

    public PinkCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setPath(){
        ...
        switch(displayMetrics.densityDpi){
            ...
            case DisplayMetrics.DENSITY_HIGH:
                ...
                if ((pink_memory_level<10)||(pink_memory_level>90)){
                    multiplier=0.545f;
                    OFFSET_VALUE=19f;
                    SINE_PAD_VALUE=10;
                }else{
       ...
       //         System.out.println("case selected is medium");
            ...
            case DisplayMetrics.DENSITY_XHIGH:
                ...
                if ((pink_memory_level>90)||(pink_memory_level<10)){
                    multiplier=0.805f;
                    SINE_PAD_VALUE=13f;
                    OFFSET_VALUE=20.5f;
                }else{
   ...
   //             Log.e(TAG,"case selected is X_high ");
    ...
    protected void onDraw(Canvas canvas) {
      ...
      //  System.out.println("========entering On draw of stroage color=============");
        ...
        canvas.translate(this.left+OFFSET_VALUE, this.top+SINE_PAD_VALUE+3);
